...
def load_config(root: Path | None = None) -> Config:
    ...
    return Config(
        ...
        fitness_drive_client_secret=project_path(os.environ.get("GOOGLE_DRIVE_CLIENT_SECRET_FILE") or "private/google-drive-client.json"),
        fitness_drive_token=project_path(os.environ.get("GOOGLE_DRIVE_TOKEN_FILE") or "private/google-drive-token.json"),
